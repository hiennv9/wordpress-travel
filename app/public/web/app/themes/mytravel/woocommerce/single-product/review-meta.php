...
if ( '0' === $comment->comment_approved ) { ?>
	...
	<div class="meta">
		<em class="woocommerce-review__awaiting-approval">
			<?php esc_html_e( 'Your review is awaiting approval', 'mytravel' ); ?>
		</em>
	</div>
...
<?php } else { ?>
	...
	<div class="meta">
		<div class="woocommerce-review__author font-weight-bold text-gray-3 h6"><?php comment_author(); ?></div>
																										<?php

																										if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
																											echo '<em class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'mytravel' ) . ')</em> ';
																										}
