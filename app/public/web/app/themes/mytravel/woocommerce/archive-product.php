		...
		<div class="tab-content">
			...
			if ( wc_get_loop_prop( 'total' ) ) {
				while ( have_posts() ) {
					...
					wc_set_loop_prop( 'tab-view', 'grid' );

					$product_format = mytravel_get_product_format();

					if ( 'standard' !== $product_format && 'hotel' !== $product_format && 'room' !== $product_format ) :
						wc_get_template_part( 'content', get_product_format() );
					else :
					...
					if ( 'standard' !== $product_format && 'hotel' !== $product_format && 'room' !== $product_format ) :
						...
						wc_get_template_part( 'content', '' . $product_format . '-list-view' );
					else :

						wc_get_template_part( 'content', 'hotel-list-view' );
					endif;

					$list_view .= ob_get_clean();
				}
			}
